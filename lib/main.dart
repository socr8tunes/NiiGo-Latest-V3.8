...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyDzaOdfjIEStv9jMlhPzD-V4dtLZXHVQ_E",
        authDomain: "niigo-official.firebaseapp.com",
        projectId: "niigo-official",
        storageBucket: "niigo-official.firebasestorage.app",
        messagingSenderId: "541507556218",
        appId: "1:541507556218:web:60908dd0c2eedded8e7cc3"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDKBbf7yHPqSHCuwLZtq06fVyecY--GO8g",
        appId: "1:541507556218:android:ea1ce94121e4eb898e7cc3",
        messagingSenderId: "541507556218",
        projectId: "niigo-official",
      ),
    );
